...
function Chat(props) {
  ...
  const dispatch = useDispatch()  // from redux  --> hooks
  ...
  const activeUser = useSelector((state) => state.activeUser)  //from redux  --> hooks
    ...
    <>
      {
        activeChat ?
          <div className={props.className} >
            <div className='flex justify-between items-center px-5 shadow-inner bg-[#DDE9F8] w-[100%]'>
            ...
            <div className='absolute inset-x-0 bottom-0'>
              ...
              <div className='border-[1px] bg-white border-[#aabac8] px-6 py-3  rounded-t-[1px]'>
                ...
                <form onKeyDown={(e) => keyDownFunction(e)} onSubmit={(e) => e.preventDefault()}>
                  ...
                  }} className='focus:outline-0 w-[100%] bg-white' type="text" name="message" placeholder="Enter message" value={message} />
                </form>

              </div>

              <div className='border-x-[1px] border-b-[1px] bg-[#f8f9fa] border-[#aabac8] px-6 py-3  rounded-b-[1px] h-[50px]'>
                {/* {
