...
function Home() {
  ...
  return (
    <>
      ...
      <div className="bg-[#282C35!] scrollbar-hide z-10 h-[100vh]  lg:mx-auto overflow-y-hidden shadow-2xl ">
        ...
        <div className='flex'>
                ...
                <div className='h-[61px] px-4'>
                  <div className='flex'>
                    <a className='flex items-center relative  -top-4 block h-[90px]' href='/'>
                      ...
                      <h3 className='text-[20px] text-[#1f2228] font-body font-sans font-semibold tracking-wider'>Messages</h3>
                    </a>
                  </div>
          ...
          <Chat className="chat-page relative lg:w-[100%] h-[100vh] bg-[#F8F4EC]"/>
